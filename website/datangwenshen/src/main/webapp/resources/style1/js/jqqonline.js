...
document.writeln("border:0;/*background:url("+ctx+"/resources/style1/images/top.gif) no-repeat center center*/");
document.writeln("}");
...
document.writeln("	BACKGROUND: url("+ctx+"/resources/style1/images/top.gif); HEIGHT: 76px");
document.writeln("}");
document.writeln("#siderIMchat_main .infobox {");
document.writeln("	TEXT-ALIGN: center; PADDING-BOTTOM: 5px; LINE-HEIGHT: 14px; PADDING-LEFT: 5px; PADDING-RIGHT: 5px; BACKGROUND: url("+ctx+"/resources/style1/images/middle.gif) #bdc5cb no-repeat; COLOR: #000; FONT-WEIGHT: 700; PADDING-TOP: 5px");
document.writeln("}");
document.writeln("#siderIMchat_main .bg {");
document.writeln("	PADDING-BOTTOM: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; BACKGROUND: url("+ctx+"/resources/style1/images/middle.gif); PADDING-TOP: 0px");
document.writeln("}");
...
document.writeln("	BACKGROUND: url("+ctx+"/resources/style1/images/bottom.gif); HEIGHT: 51px; OVERFLOW: hidden");
document.writeln("}");
...
document.writeln("<div style=\'float:right;width:24px;margin:9px 0 0 0;border: 0px;\'><img id=menutop onMouseOver=\"javascript:ChangeMenu('RightMenu',115,500)\" border=0 height=100 src='"+ctx+"/resources/style1/images/kefu.gif' width=24></div>");
document.writeln("  </div></div>")
...
function ChangeMenu(id,menuwidth,menuheight){
    ...
    if(o.style.display == "none"){
        ...
        document.getElementById("menutop").src=ctx+"/resources/style1/images/close.gif";
    }else{
        document.getElementById("menutop").src=ctx+"/resources/style1/images/kefu.gif";
