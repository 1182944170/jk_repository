...
<script type="text/javascript">
	function checkSub(){
		var names = "name,艺人名称;info,艺人简介;oldPrice,艺人原价;discount,艺人折扣;price,艺人现价;saleTime,运营时间;telphone,联系电话;validityTime,有效期;notice,须知";
                ...
                <div class="perconxq">
                    ...
                    <div class="fabu_youji">
                    	<form action="${ctx}/art/dosave${suffix}" id="names" name="names" method="POST" enctype="multipart/form-data" >
            	        	...
            	        	<input type="hidden" name="supplierType" id="supplierType" value="6" />
            	        	<input type="hidden" name="shopType" id="shopType" value="6" />
            	        	<input type="hidden" name="shopId" id="shopId" value="${shopId!}" />
            	        	
                        	<ul>
                            	<li><label>艺人名称：</label><input type="text" id="name" name="name" class="i_btn"/></li>
                                <li><label>艺人简介：</label><input type="text" id="info" name="info" class="i_btn"/></li>
                                <li><label>艺人原价：</label><input type="text" id="oldPrice" name="oldPrice" class="i_btn" /></li>
                                <li><label>艺人折扣：</label><input type="text" id="discount" name="discount" class="i_btn" /></li>
                                <li><label>艺人现价：</label><input type="text" id="price" name="price" class="i_btn" /></li>
                                ...
                                <li><label>有效期：</label><input type="text" id="time" name="validityTime" class="i_btn"/></li>
