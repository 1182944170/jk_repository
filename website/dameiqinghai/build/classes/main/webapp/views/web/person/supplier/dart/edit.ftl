            ...
            <div class="w_personr fr">
                <div class="perconxq">
                    ...
                    <div class="fabu_youji">
                    	<form action="${ctx}/art/dosave${suffix}" id="names" name-"names" method="POST" enctype="multipart/form-data" >
            	        	<input type="hidden" name="id" id="id" value="${art.id!}" />
            	        	<input type="hidden" name="userId" id="userId" value="${sessionUser.id!}" />
            	        	<input type="hidden" name="supplierType" id="supplierType" value="${art.supplierType!}" />
            	        	<input type="hidden" name="shopType" id="shopType" value="${art.shopType!}" />
            	        	<input type="hidden" name="isCommend" id="isCommend" value="${art.isCommend!}" />
                        	<ul>
                            	<li><label>商品名称：</label><input type="text" id="name" name="name" value="${art.name!}" /></li>
                                <li><label>商品简介：</label><input type="text" id="info" name="info" value="${art.info!}" /></li>
                                <li><label>商品原价：</label><input type="text" id="oldPrice" name="oldPrice" value="${art.oldPrice!}" class="i_btn" /></li>
                                <li><label>商品折扣：</label><input type="text" id="discount" name="discount" value="${art.discount!}" class="i_btn" /></li>
                                <li><label>商品现价：</label><input type="text" id="price" name="price" value="${art.price!}" class="i_btn" /></li>
                                <li><label>运营时间：</label><input type="text" id="saleTime" name="saleTime" value="${art.saleTime!}" class="i_btn" /></li>
                                <li><label>联系号码：</label><input type="text" id="telphone" name="telphone" value="${art.telphone!}" class="i_btn"/></li>
                                <li><label>有效期：</label><input type="text" id="validityTime" value="${art.validityTime!}" name="validityTime" /></li>
                                <li><label>预约方式：</label><input type="text" id="subscribeType" value="${art.subscribeType!}" name="subscribeType" /></li>
                                <li><label>使用须知：</label><input type="text" id="notice" value="${art.notice!}" name="notice" /></li>
                                <li>
	                                <label>主图上传：</label>
                                    <dl>
                                    	<dd>
