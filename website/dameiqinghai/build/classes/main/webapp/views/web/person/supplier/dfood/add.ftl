...
<script type="text/javascript">
	function checkSub(){
		var names = "name,美食名称;info,美食简介;oldPrice,美食原价;discount,美食折扣;price,美食现价;saleTime,运营时间;telphone,联系电话;validityTime,有效期;notice,须知";
                ...
                <div class="perconxq">
                    ...
                    <div class="fabu_youji">
                    	<form action="${ctx}/food/dosave${suffix}" id="names" name="names" method="POST" enctype="multipart/form-data" >
            	        	...
            	        	<input type="hidden" name="supplierType" id="supplierType" value="4" />
            	        	<input type="hidden" name="shopType" id="shopType" value="4" />
            	        	<input type="hidden" name="shopId" id="shopId" value="${shopId!}" />
                        	<ul>
                            	<li><label>美食名称：</label><input type="text" id="name" name="name" class="i_btn"/></li>
                                <li><label>美食简介：</label><input type="text" id="info" name="info" class="i_btn"/></li>
                                <li><label>美食原价：</label><input type="text" id="oldPrice" name="oldPrice" class="i_btn" /></li>
                                <li><label>美食折扣：</label><input type="text" id="discount" name="discount" class="i_btn" /></li>
                                <li><label>美食现价：</label><input type="text" id="price" name="price" class="i_btn" /></li>
