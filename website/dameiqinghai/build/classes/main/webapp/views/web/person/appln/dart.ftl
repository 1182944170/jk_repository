	                    ...
	                    <div class="fabu_youji">
	                    	<form action="${ctx}/appln/dosave${suffix}" method="POST" enctype="multipart/form-data" onsubmit="return commitSubmit()">
	                        	...
	                        	<ul>
	                                ...
	                                <li><label>店铺名称：</label><input type="text"  id="shopName" name="shopName" value="" class="a_btn" onchange="checkName(this.value,'showName');"/><b class="classerror" id="showName"></b></li>
