        ...
        <div class="w_person">
            ...
            <div class="w_personr fr">
                <div class="w_gldy">
                            ...
                            <#list artPager.itemList as u>
                            	<dd>
	                                ...
	                                <div class="dd_06 fl">
	                                	...
	                                	<#else>
		                                	<span>
		                                        <a href="${ctx}/art/edit-${u.id}${suffix}">编辑</a>
		                                        <a href="${ctx}/art/delete-${u.id}${suffix}"><img src="${ctx}/resources/images/gl_shanh.png" /></a>
		                                    </span>
	                                	</#if>
                    ...
                    <div class="w_ys">
                    	<script>
	                    	new showPages('${ctx}/art/direct${suffix}?userId=${sessionUser.id}','${artPager.totalPages?c}','${artPager.totalCount?c}','${artPager.pagerWebString}').printBaseHtml();
						</script>
                    </div>
                </div>
            </div>
