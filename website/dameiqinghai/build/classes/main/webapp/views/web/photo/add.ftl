                ...
                <div class="perconxq">
                    ...
                    <div class="fabu_youji">
                    	<form action="${ctx}/photo/dosave${suffix}" method="POST" enctype="multipart/form-data">
    						...
    						<ul>
                                <li><label>景点：</label>
                                	<select id="spotsId" name="spotsId" style="width: 100px;">
		    							<option class="i_btn"> 选择景点 </option>
		    							<#list spotsList as u>
		    								<option value="${u.id}" class="i_btn"> ${u.spotsName!} </option> 
		    							</#list>
		    						</select>      </li>
                                <li><label>照片名：</label><input type="text" id="name" name="name" value="" class="i_btn" /></li>
                                <li>
	                                <label>画册图片：</label>
                                    <dl>
                                    	<dd>
