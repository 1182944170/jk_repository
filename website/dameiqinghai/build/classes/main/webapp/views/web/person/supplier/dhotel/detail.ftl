...
<div class="w_main">
    <div class="w_jiudian_top">
    	<h4><a href="${ctx}/index${suffix}">首页</a>&gt;<a href="${ctx}/hotel${suffix}">酒店</a>&gt;<em>${hotel.shops.shopName!}</em></h4>
        ...
        <div class="w_jiudian_topr fr">
        	<div class="w_trs">
                <h5>${hotel.name!}</h5>
                <p>${hotel.onfo!}</p>
                <span>${commonTag.getCountyPath(hotel.shops.areaCode!)}</span>
                <em><u>营运时间：${hotel.saleTime!}</u><i>有效期：${hotel.validityTime!}</i></em>
            </div>
            <div class="w_trz">
            	<p>￥<em>${hotel.price!}</em></p>                
                <span><em>折扣<i>${hotel.discount!}折</i></em><u></u><em>原价<b>￥${hotel.oldPrice!}</b></em></span>
            </div>
            <div class="w_trx">
            	<span>售出302</span>
                <span>
            ...
            <div class="w_trd">
            	<dl>
            		<#if hotel.isYxkd == 1>
                		<dt><img src="${ctx}/resources/images/w_xqico01.png" alt="" /></dt>
                	<#else>
                		<dt class="w_none"><img src="${ctx}/resources/images/w_xqico01s.png" alt="" /></dt>
                	</#if>
                    <dd>有线宽带</dd>
                </dl>
                <dl>
                	<#if hotel.isLave == 1>
                		<dt><img src="${ctx}/resources/images/w_xqico02.png" alt="" /></dt>
                	<#else>
                		<dt class="w_none"><img src="${ctx}/resources/images/w_xqico02s.png" alt="" /></dt>
                	</#if>
                	<dd>带洗浴</dd>
                </dl>
                <dl>
                	<#if hotel.isWifi == 1>
                		<dt><img src="${ctx}/resources/images/w_xqico03.png" alt="" /></dt>
                	<#else>
                		<dt class="w_none"><img src="${ctx}/resources/images/w_xqico03s.png" alt="" /></dt>
                	</#if>
                	<dd>WIFI上网</dd>
                </dl>
                <dl>
                	<#if hotel.isZc == 1>
                		<dt><img src="${ctx}/resources/images/w_xqico04s.png" alt="" /></dt>
                	<#else>
                		<dt class="w_none"><img src="${ctx}/resources/images/w_xqico04.png" alt="" /></dt>
                	</#if>
            		<dd>免费早餐</dd>
                </dl>
                <dl>
                	<#if hotel.isPark == 1>
                		<dt><img src="${ctx}/resources/images/w_xqico05s.png" alt="" /></dt>
                	<#else>
                		<dt class="w_none"><img src="${ctx}/resources/images/w_xqico05.png" alt="" /></dt>
                	</#if>
            		<dd>免费停车</dd>
                </dl>
            </div>
        ...
        <div class="w_jdtops">
            ...
            <div class="w_jdadr" id="w_xh01">
                ...
                <div class="w_jdar">
                    ...
                    <span>
                        <h6>${hotel.shops.shopName!}</h6>
                        <p>地址：${commonTag.getCountyPath(hotel.shops.areaCode!)} ${hotel.address!}</p>
                        <p>电话：${hotel.telphone!}</p>
                        <p>公交：12路  7路</p>
                    </span>
                </div>
            </div>
            <div class="w_jdadr" id="w_xh02">
            	<h5>购买须知</h5>
                <div class="w_jdatd">
                    <div><span>有效期</span><em>${hotel.validityTime}</em></div>
                    <div><span>预约方式</span><em>${hotel.subscribeType}</em></div>
                    <div><span>入住须知</span><em>${hotel.notice}</em></div>
            ...
            <div class="w_jdadr" id="w_xh04">
                ...
                <div class="w_hypj">
                    ...
                    <input type="hidden" value="${hotel.id!}" name="supplierId" />
    ...
    <div class="w_mainr fr">
    	<div class="w_hotelcon">
        	<h4><a href="${ctx}/hotel${suffix}">推荐酒店</a></h4>
            <div class="w_dajia">
            	<ul>
            		<#list supplierList as u>
	                    <li>
	                   		<a href="${ctx}/hotel/detail-${u.id}${suffix}"><img src="${ctx}/resources/images/w_hpic04.jpg" width="100" height="76" alt="" /></a>
	                    	<h6><a href="${ctx}/hotel/detail-${u.id}${suffix}">${u.shopName!}</a></h6>
	                        <span><em>￥</em>${u.price!}<i>￥${u.oldPrice!}</i></span>
	                        <div><u><img src="${ctx}/resources/images/w_pf.png" /><img src="${ctx}/resources/images/w_pf.png" /><img src="${ctx}/resources/images/w_pf.png" /><img src="${ctx}/resources/images/w_pf.png" /><img src="${ctx}/resources/images/w_pfh.png" />4分</u><i>售出302</i></div>
	                    </li>
                    </#list>
                </ul>
            </div>
