...
<div class="w_main">
    <div class="w_jiudian_top">
    	<h4><a href="${ctx}/index${suffix}">首页</a>&gt;<a href="${ctx}/art${suffix}">艺人</a>&gt;<em>${art.shops.shopName!}</em></h4>
        ...
        <div class="w_jiudian_topr fr">
        	<div class="w_trs">
                <h5>${art.name!}</h5>
                <p>${art.info!}</p>
                <span>${commonTag.getCountyPath(art.shops.areaCode!)}</span>
                <em><u>营运时间：${art.saleTime!}</u><i>有效期：${art.validityTime!}</i></em>
            </div>
            <div class="w_trz">
            	<p>￥<em>${art.price!}</em></p>                
                <span><em>折扣<i>${art.discount!} 折</i></em><u></u><em>原价<b>￥${art.oldPrice!}</b></em></span>
            </div>
            <div class="w_trx">
            	<span>售出302</span>
                <span>
        ...
        <div class="w_jdtops">
            ...
            <div class="w_jdadr" id="w_xh01">
                ...
                <div class="w_jdar">
                    ...
                    <span>
                       	<h6>${art.shops.shopName!}</h6>
                        <p>地址：${commonTag.getCountyPath(art.shops.areaCode!)}${art.address!}</p>
                        <p>电话：${art.telphone!}</p>
                        <p>公交：12路  7路</p>
                    </span>
                </div>
            ...
            <div class="w_jdadr" id="w_xh02">
            	<h5>购买须知</h5>
                <div class="w_jdatd">
                    <div><span>有效期</span><em>2015.4.30 至 2016.4.29（周末、法定节假日通用）</em></div>
                    <div><span>预约方式</span><em>2015.4.30 至 2016.4.29（周末、法定节假日通用）</em></div>
                    <div><span>入住须知</span><em>请在14点之后入住并于次日12点之前退房；如需提前入住或延时退房，请咨询店家入住时需交押金，并出示身份证（一人一证），押金数以商家反馈为准请不要携带宠物入住</em></div>
            ...
            <div class="w_jdadr" id="w_xh04">
                ...
                <div class="w_hypj">
                    ...
                    <input type="hidden" value="${art.id!}" name="supplierId" />
    	...
    	<div class="w_hotelcon">
            ...
            <div class="w_dajia">
            	<ul>
            		<#list artList as u>
	                    <li>
	                   		<a href="${ctx}/art/detail-${u.id}${suffix}"><img src="${ctx}/resources/images/w_hpic04.jpg" width="100" height="76" alt="" /></a>
	                    	<h5>${u.name!}</h5>
