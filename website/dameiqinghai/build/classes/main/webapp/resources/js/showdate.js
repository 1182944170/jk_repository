...
'a {height:18px;color:#000;padding-top:2px;text-decoration:none;display:block;cursor:pointer;}'+
...
'#Tools {width:204px;background:#ccc;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #ddd;background:#bbb;}'+
'#Title {width:204px;background:#ddd;border-bottom:1px solid #000;}'+
...
'#Select #SelectBn {background:#ddd;font-size:8px;line-height:7px;height:7px;text-align:center;color:#44b6ae;}'+
...
'</div><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Next\\\',\\\'Y\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-top:1px solid #ddd;"><font face="Webdings">&#54;</font></a></div></div>'+
