jQuery.fn.fancyZoom = function(options){
  ...
  if ($('#w_zoom').length == 0) {
    var html = '<div class="round_shade_box" id="w_zoom"> \
    ...
    $('html').click(function(e){if($(e.target).parents('#w_zoom:visible').length == 0) hide();});
    $(document).keyup(function(event){
        if (event.keyCode == 27 && $('#w_zoom:visible').length > 0) hide();
    });
    
    $('#w_zoom_close').click(hide);
  }
