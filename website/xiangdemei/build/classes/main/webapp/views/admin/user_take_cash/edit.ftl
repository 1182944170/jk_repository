...
<div class="form-group">
	<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="userId">会员ID:</label>
	<div class="col-xs-12 col-sm-9">
		<div class="clearfix">
			<span class="block input-icon width-30">
				<input type="text" name="userId" id="userId" value="${(userTakeCash.userId)!''}" readonly class="form-control" placeholder="会员ID"/>
				<i class="icon-user"></i>
			</span>
		</div>
	</div>
	...
	<div class="col-xs-12 col-sm-9">
		<div class="clearfix">
			<span class="block input-icon width-80">
				${userTakeCash.name}-${userTakeCash.account}
				[${userTakeCash.address}-${userTakeCash.cfgBank.name}]<br/>
				身份证: ${userTakeCash.idCard!}
			</span>
		</div>
	</div>
</div>
