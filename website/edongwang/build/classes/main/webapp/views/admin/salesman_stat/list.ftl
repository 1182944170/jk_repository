...
<form class="form-horizontal" role="form" id="validation-form" method="POST" action="${ctx}/admin/salesman_stat/list" onsubmit="return fromSearch(this)">
	...
	<label>接单人名字:</label>
	<input type="text" name="realName" value="${(pager.searchMap.realName)!''}" placeholder="接单人名字"/>
		...
		<div class="table-responsive">
			<table id="sample-table-1" class="table table-striped table-bordered table-hover">
				...
				<tr>
					...
					<td></td>
					<td></td>
					<td><span class="orange center">总 计</span></td>
					<td><span class="orange center">${totalCollect.grabCount}</span></td>
					<td><span class="orange center">${totalCollect.dealCount}</span></td>
					<td><span class="orange center">${totalCollect.totalSurface}㎡</span></td>
					<td><span class="orange center">${totalCollect.totalDealPrice}万元</span></td>
				</tr>
