		...
		<div class="col-xs-12 col-sm-9">
			...
			<div class="profile-user-info profile-user-info-striped">
				...
				<div class="profile-info-row">
					...
					<div class="profile-info-value">
						<span class="editable" id="username">${user.contact} &nbsp;&nbsp;<a class="green" href="${ctx}/admin/user/${user.id}/change_contact${suffix}">[修改手机号]</a></span>
					</div>
				</div>
				<div class="profile-info-row">
					...
					<div class="profile-info-value">
						<span class="editable" id="username">
							...
							<#else>
								...
								&nbsp;&nbsp;<a class="green" href="${ctx}/admin/user/${user.id}/change_salesman${suffix}" alt="change_salesman">
									[重新认证]
								</a>
								</span>
							</#if>
