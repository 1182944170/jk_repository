...
<div class="z_login">
	<div class="z_logintitle">
        <dl>
            <dt><img src="../img/login/logo.png" width="84" height="84"></dt>
    ...
    <div class="z_loginmain" style="height:499px;">
        <form>
            <div class="z_loginmain_left" style="height:450px;">
                <div class="z_img01"><img src="../img/login/img01.png" width="228" height="388" /></div>
            </div>
            <div class="z_loginmain_right" style="height:450px;">
                <div class="z_bang">
                    ...
                    <ul>
                        ...
                        <li><span>校验码：</span><div><input type="text" class="z_input3" /><a href="#"><img src="../img/login/huo.jpg" width="61" height="30" /></a><em>输入手机手机接收的6位纯数字</em></div></li>
