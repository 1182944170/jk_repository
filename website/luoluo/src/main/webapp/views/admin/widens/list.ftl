			...
			<#list pager.itemList as u>
					<tr>
						...
						<td>
							...
							<#if u.type==0>
								<a class="red" href="${ctx}/admin/windens/${u.id}/saveUserda${suffix}" onclick="return confirm('你确定禁止用户么?');" alt="Delete">
									<img src="${ctx}/resources/images/zhengque.jpg" width="15" height="15" alt="" />
								</a>
							<#elseif u.type==1>
								<a class="red" href="${ctx}/admin/windens/${u.id}/saveUserda${suffix}" onclick="return confirm('你确定允许用户么?');" alt="Delete">
