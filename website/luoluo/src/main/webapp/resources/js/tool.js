...
function dateDiff(interval, date1, date2){
    ...
    try{
        switch(interval){
        	case "D" : return Math.round((dt2 - dt1) / (objInterval.D));break;
        	case "H" : return Math.round((dt2 - dt1) / (objInterval.H));break;
        	case "M" : return Math.round((dt2 - dt1) / (objInterval.M));break;
        	case "S" : return Math.round((dt2 - dt1) / (objInterval.T));break;
        	case "T" : return Math.round((dt2 - dt1) / (objInterval.S));break;
        	default :break;
        }
    } catch (e){
        return e.message;
