...
public final class StringUtils {
		...
		/**
		 * 在字符串中查找指定字符，并返回第一个匹配的索引值。如果字符串为 <code>null</code> 或未找到，则返回
		 * <code>-1</code>。
		 * 
		 * <pre>
		 *   
		...
		/**
		 * 在字符串中查找指定字符串，并返回第一个匹配的索引值。如果字符串为 <code>null</code> 或未找到，则返回
		 * <code>-1</code>。
		 * 
		 * <pre>
		 *   
		 ...
		 * 
		 * <p>
		 * 如果字符串为 <code>null</code> ，则返回 <code>false</code>。 如果字符集合为
		 * <code>null</code> 则返回 <code>false</code>。 但是空字符串永远返回
		 * <code>true</code>.
		 * </p>
		 * 
		 * <pre>
		 ...
		 * <p>
		 * 如果字符串为 <code>null</code> ，则返回 <code>false</code>。 如果字符集合为
		 * <code>null</code> 则返回 <code>true</code>。 但是空字符串永远返回
		 * <code>true</code>.
		 * </p>
		 * 
		 * <pre>
		 ...
		 * 
		 * <p>
		 * 如果字符串为 <code>null</code> ，则返回 <code>null</code>。 如果分隔子串为
		 * <code>null</code> 或未找到该子串，则返回原字符串。
		 * 
		 * <pre>
		 *   
		 ...
		 * 
		 * <p>
		 * 如果字符串为 <code>null</code> 则返回 <code>null</code> ，如果指定子串为
		 * <code>null</code> ，则返回原字符串。
		 * 
		 * <pre>
		 *   
		 ...
		 * 
		 * <p>
		 * 如果字符串为 <code>null</code> 则返回 <code>null</code> 。如果搜索字符串为
		 * <code>null</code> 或空，则返回原字符串。
		 * </p>
		 * 
		 * <p>
		 * 例如：
		 ...
		 * 
		 * <p>
		 * 如果字符串为 <code>null</code> ，则返回 <code>null</code>。 负的索引值将被看作
		 * <code>0</code> ，越界的索引值将被设置成字符串的长度相同的值。
		 * 
		 * <pre>
		 *   
		 ...
		 *            要检查的字符串
		 * @param maxWidth
		 *            最大长度，不小于 <code>4</code> ，如果小于 <code>4</code> ，则看作
		 *            <code>4</code>
		 * 
		 ...
		 * <p>
		 * 这个算法取自 <a
		 * href="http://www.merriampark.com/ld.htm">http://www.merriampark.com/ld.htm
		 * </a>。 它计算的是从字符串1转变到字符串2所需要的删除、插入和替换的步骤数。
		 * </p>
		 * 
		 * <pre>
		 *   
		...
		/**
		 * 生成上传文件的文件夹名字
		 * 根据uuid里面的四个字母产生文件夹目录
		 * @param id
		 * @return
		 */	
		private StringBuffer genratorUploadFolder(String id){
			StringBuffer uploadFoler = new StringBuffer();
			String str = StringUtils.mid(id, 20, 4);
			char[] ch= str.toCharArray();
			for(int i =0 ;i<ch.length;i++){
				uploadFoler.append(FILE_SEPARATOR);
				uploadFoler.append(ch[i]);
			}
			return uploadFoler;
		}

		public String fileName2Path(String id) throws Exception {
			//1.判断入参 
			if(StringUtils.isBlank(id)){
				return null;
			}
			//生成上传文件夹
			StringBuffer uploadFolder = genratorUploadFolder(id);		
			//返回图片的URL	
			return "upload" + uploadFolder.toString() +FILE_SEPARATOR+id;
		}
		 ...
		 * @return
		 */
		public static String abbreviateWithoutDot(String str, int maxWidth) {
			if (str == null) {
				return null;
			}
			if(str.length()<maxWidth){
			...
			//return abbreviateWithoutDot(str, 0, maxWidth);
		}
		 ...
		 * @return 字符串缩略，如果原始字符串为 <code>null</code> 则返回 <code>null</code>
		 */
		public static String abbreviateWithoutDot(String str, int offset, int maxWidth) {
			if (str == null) {
				return null;
			}
			...
			if ((offset + (maxWidth - 3)) < str.length()) {
				return abbreviateWithoutDot(str.substring(offset), maxWidth - 3);
			}
