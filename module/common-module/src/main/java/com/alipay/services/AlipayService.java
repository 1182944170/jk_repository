...
public class AlipayService {
    ...
    public static String create_direct_pay_by_user(Map<String, String> sParaTemp) {
        ...
        sParaTemp.put("return_url", AlipayConfig.getInstance().getReturnUrl());
        sParaTemp.put("notify_url", AlipayConfig.getInstance().getNotifyUrl());
        sParaTemp.put("seller_email", AlipayConfig.getInstance().seller_email);
        sParaTemp.put("_input_charset", AlipayConfig.getInstance().input_charset);
