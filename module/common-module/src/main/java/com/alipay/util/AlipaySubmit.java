...
public class AlipaySubmit {
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        sPara.put("sign_type", AlipayConfig.getInstance().sign_type);
    ...
    public static String buildForm(Map<String, String> sParaTemp, String gateway, String strMethod,
        ...
        sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + gateway
                      + "_input_charset=" + AlipayConfig.getInstance().input_charset + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String sendPostInfo(Map<String, String> sParaTemp, String gateway)
        ...
        //设置编码集
        request.setCharset(AlipayConfig.getInstance().input_charset);

        request.setParameters(generatNameValuePair(sPara));
        request.setUrl(gateway+"_input_charset="+AlipayConfig.getInstance().input_charset);
